...
class DriverManagementController extends Controller
{
    ...
    public function verifyVehicle(Vehicle $vehicle)
    {
        ...
        Notification::create([
            ...
            'message' => 'Your vehicle '
                ...
                . ' has been verified. You can now accept delivery pools.',
        ...
        AdminLog::create([
            ...
            'description' => 'Verified vehicle: ' . $vehicle->vehicle_number,
            'ip_address' => request()->ip(),
        ]);

        return back()->with(
            'success',
            'Vehicle ' . $vehicle->vehicle_number . ' has been verified.'
        );
    }
}